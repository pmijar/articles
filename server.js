...
app.get("/bbc", function (req, res) {
  ...
  axios.get("https://www.bbc.com/news/world").then(function (response) {
    ...
    $("h3").each(function (i, element) {
      ...
      // Add the newsChannel, title, summary and href of every link, and save them as properties of the result object
      result.newsChannel = "BBC";
      result.title = $(this)
        .text().trim();
      result.summary = $(this)
        .parent()
    ...
    res.send("BBC Website Scrape Complete");
  });
});
...
/*       result.summary = $(this)
    ...
    // Send a message to the client
    res.send("CNN Website Scrape Complete");
  });
});
